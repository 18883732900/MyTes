...
class test02():
    ...
    element11 = (By.CSS_SELECTOR,
                 'div.uploadInfo:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > img:nth-child(1)')
    ...
    element24 = (By.CSS_SELECTOR, '.el-message-box__btns > button > span:nth-child(1)')
